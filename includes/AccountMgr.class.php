...
class AccountMgr
{
	...
	static function getHistory($guid, $full = false)
	{
		...
		if (!$full && self::getLastVerwarnstufe($guid) < 5)
			$html .= "<tr><td>*</td><td>". self::buildStufenSelect(self::getLastVerwarnstufe($guid)) ."</td><td><textarea type=\"text\" name=\"kommentar\" id=\"kommentar\" cols=\"30\" rows=\"5\" /></textarea></td><td>*</td></tr>";
		return($html);
	}
